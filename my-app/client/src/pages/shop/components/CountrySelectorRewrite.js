...
class CountrySelectorRewrite extends React.Component {
  ...
  componentDidMount = () => {
    ...
    countries.forEach(country => {
      if (country.code === CountriesCode.Indonesia) {
  ...
  submitRegions = value => {
    ...
    if (this.state.selectedCountry === CountriesCode.Indonesia) {
      this.props.form.setFieldValue('countryId', CountriesCode.Indonesia);
    }
  };
